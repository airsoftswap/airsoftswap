...
export default function Messagerie() {
  const { user, setShowAuth } = useApp(); const navigate = useNavigate()
          ...
          {!active
            ...
            : <>
              <div className="msg-chat-head">
                ...
                <div><div style={{fontSize:13,fontWeight:600}}>{active.otherName}</div><div style={{fontSize:11,color:'var(--text3)'}}>{active.annonce?.titre}</div></div>
              </div>
